  ...
  describe('*** Client Tests ***', () => {
    ...
    describe('GET /client/companies', () => {
      ...
      it('Returns a list of companies', async () => {
        const requestPath = `${apiPaths.v1.clientBasePath}/${resources.companies}?offset=${offset}&limit=${limit}`;
    ...
    describe('GET /v1/client/companies/{company_id}', () => {
      ...
      it('Returns a single json object of a company', async () => {
        const requestPath = `${apiPaths.v1.clientBasePath}/${resources.companies}/${selectedCompany.id}`;
    ...
    describe('POST /v1/client/companies', () => {
      ...
      it('Creates a single Company', async () => {
        const requestPath = `${apiPaths.v1.clientBasePath}/${resources.companies}`;
    ...
    describe('PUT /v1/client/companies/{company_id}', () => {
      const [selectedCompany] = companies;
    ...
    describe('DELETE /v1/client/companies/{company_id}', () => {
      const [selectedCompany] = companies;
